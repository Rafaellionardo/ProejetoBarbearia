 ...
 * @author Rafael
 */
public class Atu extends javax.swing.JFrame {
    ...
    public Atu(){
                try {
                    ...
                    Logger.getLogger(Atu.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void initComponents() {
        ...
        NomeFac.setEnabled(false);

        jLabel4.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 18)); // NOI18N
        jLabel4.setText("WhatsApp:");

        Wats.setEnabled(false);
        ...
        jButton1.setFont(new java.awt.Font("Vladimir Script", 0, 36)); // NOI18N
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(rg, javax.swing.GroupLayout.DEFAULT_SIZE, 257, Short.MAX_VALUE)
                                            .addComponent(cpf)
...
//  pst.setDate(3, java.sql.Date.valueOf(jLData.getText()));
    ...
    @SuppressWarnings("empty-statement")
     public void preencherTabela(String SQL) throws SQLException{
            ...
            conex.rs.first();
                ...
                try {
                    nom.getBytes(conex.rs.getString("nome"));
                    idad= conex.rs.getInt("idade");
                    sex.getBytes(conex.rs.getString("sexo"));
                ru.getBytes(conex.rs.getString("rua"));
                numer= conex.rs.getInt("numero");
               cidad.getBytes(conex.rs.getString("cidade"));
             u.getBytes(conex.rs.getString("uf"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Atu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
